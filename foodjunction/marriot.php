...
header{
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(m1.jpg);
	height: 100vh;
	...
	<header>
		<div class="main">
			...
			<ul> 
				...
				<li><a href="https://www.marriott.com/en-us/hotels/bhocy-courtyard-bhopal/overview/">Website</a></li>
...
- Staff<br>
<br>
On both counts of Accessibility and Amenities, the COURTYARD would rank High... considering its location, the decor, the restaurants within the premises, and the little <br>thoughtful touches at every corner.
<br><br>
