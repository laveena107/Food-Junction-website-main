...
header{
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(rg1.jpg);
	height: 100vh;
	...
	<header>
		<div class="main">
			...
			<ul> 
				...
				<li><a href="http://www.ranjeethotels.com/">Website</a></li>
				<li><a href="http://localhost/foodjunction/logout.php">Logout</a></li>
			</ul>
		</div>	
		<div class="title">
			<h1>GOLDEN OAK RESORT</h1>
		</div>
...
- Staff<br>
<br>
On both counts of Accessibility and Amenities, the Jehan Numa Palace would rank High... considering its location, the decor, the restaurants within the premises, and the little <br>thoughtful touches at every corner.
<br><br>
