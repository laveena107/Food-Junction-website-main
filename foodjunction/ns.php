...
header{
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(ns1.jpg);
	height: 100vh;
	...
	<header>
		<div class="main">
			...
			<li ><a href="http://localhost/foodjunction/grid.php">Home</a></li>
				<li><a href="http://www.noorussabahpalace.com/">Website</a></li>
...
- Staff<br>
<br>
On both counts of Accessibility and Amenities, the NOOR-US-SABAH would rank High... considering its location, the decor, the restaurants within the premises, and the little <br>thoughtful touches at every corner.
<br><br>
